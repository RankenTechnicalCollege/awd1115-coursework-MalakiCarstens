...
using Auction_App.Data.Services;
...
namespace Auction_App.Controllers
{
    public class ListingsController : Controller
    {
        ...
        public ListingsController(IListingsService listingService, IBidsService bidService, ICommentsService commentsService, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public async Task<IActionResult> AddBid([Bind("Id, Price, Listing, ListingId, IdentityUser")] Bid bid)
        {
        ...
        public async Task<IActionResult> AddComment([Bind("Id, Text, ListingId, IdentityUserId")] Comment comment)
        {
            if (ModelState.IsValid)
            {
